...
///////////////////////////////////////////////////////////////////////////////
/* AtkBoost Class */
AtkBoost::AtkBoost(int row=0, int col=0):Potion{row,col}
{
...
///////////////////////////////////////////////////////////////////////////////
/* AtkWound Class */
AtkWound::AtkWound(int row=0, int col=0):Potion{row,col}
{    
}
...
///////////////////////////////////////////////////////////////////////////////
/* DefBoost Class */
DefBoost::DefBoost(int row=0, int col=0):Potion{row,col}
{
...
DefWound::DefWound(int row=0, int col=0):Potion{row,col}
{
...
HPBoost::HPBoost(int row=0, int col=0):Potion{row,col}
{
...
HPWound::HPWound(int row=0, int col=0):Potion{row,col}
{
